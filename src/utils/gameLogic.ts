...
// ⚡ Bolt Optimization: What: Hoist static arrays outside React components.
// Why: Prevents redundant array/object recreation on every render cycle.
// Impact: Reduces garbage collection overhead and improves render performance.
