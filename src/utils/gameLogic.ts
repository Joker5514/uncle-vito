...
// ⚡ Bolt Optimization:
// What: Extracting static arrays to constants.
// Why: Prevents redundant array allocation and garbage collection overhead on every render cycle of the RouletteGame component.
// Impact: Reduces memory usage and CPU time during renders.
