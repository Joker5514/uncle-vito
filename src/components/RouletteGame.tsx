  ...
  return (
    <div className="w-full text-white">
      ...
      <div className="bg-green-900/80 rounded-lg p-4 border-2 border-amber-500/50 mb-4">
        {/* ⚡ Bolt Optimization:
            What: Extracted static arrays (numbers, bet types, chip values) to constants in gameLogic.ts.
            Why: Prevents unnecessary array instantiations, garbage collection, and memory allocation during React re-renders.
            Impact: Removes array instantiations from every render cycle of RouletteGame.
        */}
