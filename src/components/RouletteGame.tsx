    ...
    <div className="w-full text-white">
      ...
      <div className="bg-green-900/80 rounded-lg p-4 border-2 border-amber-500/50 mb-4">
        <div className="grid grid-cols-6 gap-1 mb-2">
          {/* ⚡ Bolt Optimization: Hoisted ROULETTE_NUMBERS array to prevent recreation on every render */}
        ...
        <div className="grid grid-cols-6 gap-1 mt-2">
          {/* ⚡ Bolt Optimization: Hoisted ROULETTE_BET_TYPES array to prevent recreation on every render */}
      ...
      <div className="flex gap-2 justify-center items-center">
        <div className="flex gap-2">
          {/* ⚡ Bolt Optimization: Hoisted ROULETTE_CHIPS array to prevent recreation on every render */}
...
// ⚡ Bolt Optimization: Memoize heavy component to prevent unnecessary re-renders when parent state changes
