...
// ⚡ Bolt Optimization:
// What: Wrapping top-level RouletteGame in React.memo.
// Why: Prevents unnecessary re-renders when the parent App/TutorMode component re-renders (e.g., from other state changes).
// Impact: Improves overall application responsiveness by reducing React reconciliation cycles.
const RouletteGame: React.FC<{ setVitoMessage: (msg: VitoMessage) => void }> = React.memo(({ setVitoMessage }) => {
