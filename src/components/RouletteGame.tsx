  ...
  return (
    <div className="w-full text-white">
      ...
      <div className="bg-green-900/80 rounded-lg p-4 border-2 border-amber-500/50 mb-4">
        {/* ⚡ Bolt Optimization:
            What: Hoisted ROULETTE_NUMBERS, ROULETTE_BET_TYPES, and ROULETTE_CHIPS arrays.
            Why: Prevents redundant memory allocations and garbage collection on every render.
