...
const RouletteGame: React.FC<{ setVitoMessage: (msg: VitoMessage) => void }> = ({ setVitoMessage }) => {
  ...
  return (
    <div className="w-full text-white">
      ...
      {/* ⚡ Bolt Optimization: Hoisted static arrays and styles outside of component render loop to prevent redundant allocations and garbage collection on every render. */}
