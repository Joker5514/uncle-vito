...
import { ROULETTE_NUMBER_COLORS, ROULETTE_NUMBERS, ROULETTE_BET_TYPES, ROULETTE_CHIPS, ROULETTE_CHIP_COLOR_CLASSES } from '../utils/gameLogic';
    ...
    <div className="w-full text-white">
      ...
      <div className="bg-green-900/80 rounded-lg p-4 border-2 border-amber-500/50 mb-4">
        <div className="grid grid-cols-6 gap-1 mb-2">
          {/* ⚡ Bolt Optimization: Hoisted static array ROULETTE_NUMBERS prevents redundant memory allocation on every render */}
...
// ⚡ Bolt Optimization: Wrapped RouletteGame in React.memo to prevent unnecessary re-renders when parent state changes but props do not.
