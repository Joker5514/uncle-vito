...
const BlackjackGame: React.FC<{ setVitoMessage: (msg: VitoMessage) => void }> = ({ setVitoMessage }) => {
  ...
  // ⚡ Bolt: Compute scores directly during render to prevent unnecessary double re-renders.
  // Avoids using useState and useEffect for derived state, since score calculations are cheap.
