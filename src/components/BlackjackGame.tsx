...
const BlackjackGame: React.FC<{ setVitoMessage: (msg: VitoMessage) => void }> = ({ setVitoMessage }) => {
  ...
  // ⚡ Bolt: Removed `playerScore` and `dealerScore` from state and `useEffect` to avoid unnecessary double-render cycles.
  // Calculating derived state directly during render is significantly faster.
