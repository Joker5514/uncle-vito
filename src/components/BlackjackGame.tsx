...
const BlackjackGame: React.FC<{ setVitoMessage: (msg: VitoMessage) => void }> = ({ setVitoMessage }) => {
  ...
  // ⚡ Bolt: Removed redundant useState and useEffect for playerScore and dealerScore.
  // Calculating derived state directly during render prevents a double render cycle
  // every time a card is dealt or drawn.
