...
const BlackjackGame: React.FC<{ setVitoMessage: (msg: VitoMessage) => void }> = ({ setVitoMessage }) => {
  ...
  // ⚡ Bolt: Removed derived state (useState/useEffect) for playerScore and dealerScore to prevent redundant re-renders. Computing directly during render is faster and safer.
