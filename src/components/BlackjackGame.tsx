...
const BlackjackGame: React.FC<{ setVitoMessage: (msg: VitoMessage) => void }> = ({ setVitoMessage }) => {
  ...
  // ⚡ Bolt Optimization: Derive state during render instead of using useEffect/useState
  // This prevents unnecessary double render cycles when playerHand or dealerHand changes.
