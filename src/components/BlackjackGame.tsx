...
const BlackjackGame: React.FC<{ setVitoMessage: (msg: VitoMessage) => void }> = ({ setVitoMessage }) => {
  ...
  // ⚡ Bolt Performance Optimization: Calculate derived state directly during render
  // This prevents the extra render cycle caused by updating state inside a useEffect
