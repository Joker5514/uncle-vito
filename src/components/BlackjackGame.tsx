...
const BlackjackGame: React.FC<{ setVitoMessage: (msg: VitoMessage) => void }> = ({ setVitoMessage }) => {
  ...
  // Calculate derived state directly during render instead of using useEffect
  // This prevents an unnecessary double render cycle when playerHand or dealerHand changes.
