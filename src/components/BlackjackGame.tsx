...
const BlackjackGame: React.FC<{ setVitoMessage: (msg: VitoMessage) => void }> = ({ setVitoMessage }) => {
  ...
  // ⚡ Bolt: Derived state. Calculated during render to prevent double re-render cycles
  // that would occur if we synced these via useEffect and separate state variables.
