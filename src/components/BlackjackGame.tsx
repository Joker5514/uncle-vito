...
const BlackjackGame: React.FC<{ setVitoMessage: (msg: VitoMessage) => void }> = ({ setVitoMessage }) => {
  ...
  // ⚡ Bolt: Removed derived state (useState + useEffect) for scores
  // Calculating directly during render prevents unnecessary double render cycles
  // when playerHand or dealerHand are updated
