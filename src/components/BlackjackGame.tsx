...
const BlackjackGame: React.FC<{ setVitoMessage: (msg: VitoMessage) => void }> = ({ setVitoMessage }) => {
  ...
  // Optimization: Calculate derived state directly during render to prevent unnecessary re-renders.
...
// Optimization: Prevent redundant re-renders by wrapping the heavy component in React.memo.
