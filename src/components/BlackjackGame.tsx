...
// ⚡ Bolt Optimization:
// What: Wrapped BlackjackGame in React.memo
// Why: Prevents unnecessary re-renders of the heavy game component if parent state changes without affecting props.
