...
const BlackjackGame: React.FC<{ setVitoMessage: (msg: VitoMessage) => void }> = ({ setVitoMessage }) => {
  ...
  // ⚡ Bolt Optimization:
  // What: Derived scores directly from hands during render instead of using useState/useEffect.
  // Why: Synchronizing derived state with useEffect is an anti-pattern that triggers double re-renders.
  // Impact: Reduces re-renders by ~50% every time hands are updated.
