...
const BlackjackGame: React.FC<{ setVitoMessage: (msg: VitoMessage) => void }> = ({ setVitoMessage }) => {
  ...
  // ⚡ Bolt Optimization:
  // What: Replaced useState and useEffect for player/dealer scores with direct calculation during render.
  // Why: Avoids unnecessary double-renders caused by syncing derived state via useEffect.
  // Impact: Reduces React re-renders by ~50% per card drawn.
