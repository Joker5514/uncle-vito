...
const BlackjackGame: React.FC<{ setVitoMessage: (msg: VitoMessage) => void }> = ({ setVitoMessage }) => {
  ...
  // ⚡ Bolt Optimization: Compute derived state directly during render
  // This prevents the redundant render cycle that would occur if we used useState + useEffect.
...
// ⚡ Bolt Optimization: Wrap heavy components in React.memo
// Prevents unnecessary re-renders when parent components update without changing props.
