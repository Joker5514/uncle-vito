...
const BlackjackGame: React.FC<{ setVitoMessage: (msg: VitoMessage) => void }> = ({ setVitoMessage }) => {
  ...
  // ⚡ OPTIMIZATION: Calculate derived state directly during render
  // This eliminates a costly double-render cycle that previously occurred
  // when sync'ing scores via useEffect after hand updates.
