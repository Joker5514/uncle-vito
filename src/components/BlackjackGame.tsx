...
const BlackjackGame: React.FC<{ setVitoMessage: (msg: VitoMessage) => void }> = ({ setVitoMessage }) => {
  ...
  // ⚡ Bolt: Derive state during render instead of using useEffect/useState to prevent double re-renders
...
// ⚡ Bolt: Wrap heavy component in React.memo to prevent re-renders when parent state changes
