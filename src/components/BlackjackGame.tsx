...
const BlackjackGame: React.FC<{ setVitoMessage: (msg: VitoMessage) => void }> = ({ setVitoMessage }) => {
  ...
  // ⚡ Bolt: Derived state optimization - calculate scores directly during render
  // This avoids double re-renders that occur when using useEffect + useState to sync derived values
