...
const BlackjackGame: React.FC<{ setVitoMessage: (msg: VitoMessage) => void }> = ({ setVitoMessage }) => {
  ...
  // ⚡ Bolt: Derived state. Calculated directly during render cycle to avoid unnecessary double-render
  // from using useEffect to sync these values with the hand arrays.
