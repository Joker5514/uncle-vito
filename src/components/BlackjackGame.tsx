...
const BlackjackGame: React.FC<{ setVitoMessage: (msg: VitoMessage) => void }> = ({ setVitoMessage }) => {
  ...
  // ⚡ Bolt: Derived state. Calculate scores directly during render to prevent redundant render cycles.
...
// ⚡ Bolt: Wrapped heavy component in React.memo to prevent redundant memory allocations and unnecessary re-renders.
