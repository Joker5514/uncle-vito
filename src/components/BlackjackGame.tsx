...
const BlackjackGame: React.FC<{ setVitoMessage: (msg: VitoMessage) => void }> = ({ setVitoMessage }) => {
  ...
  // ⚡ Bolt Performance Optimization: Calculated derived state directly during render to prevent redundant re-renders and eliminate unnecessary useEffect synchronization overhead.
...
// ⚡ Bolt Performance Optimization: Wrapped heavy BlackjackGame component in React.memo to prevent unnecessary re-renders.
