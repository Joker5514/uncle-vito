...
const BlackjackGame: React.FC<{ setVitoMessage: (msg: VitoMessage) => void }> = ({ setVitoMessage }) => {
  ...
  // ⚡ Bolt Performance Optimization: Compute derived scores directly during render to prevent unnecessary double re-renders. No useMemo needed due to low computational cost.
