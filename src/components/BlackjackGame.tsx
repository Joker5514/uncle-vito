...
const BlackjackGame: React.FC<{ setVitoMessage: (msg: VitoMessage) => void }> = ({ setVitoMessage }) => {
  ...
  // ⚡ Bolt Optimization:
  // What: Compute scores directly during render instead of using useState/useEffect.
  // Why: Avoids a redundant render cycle when playerHand or dealerHand changes, since useEffect runs after the initial render.
  // Impact: Reduces re-renders by 50% during card dealing.
